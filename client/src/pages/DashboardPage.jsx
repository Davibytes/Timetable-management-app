...
const DashboardPage = () => {
    ...
    return (
        <DashboardLayout title="Dashboard">
            ...
            <div className="mb-8">
                <h2
                    className={`text-3xl sm:text-4xl font-comfortaa font-bold mb-2 ${isDark ? 'text-text-dark-primary' : 'text-text-light-primary'
                        }`}
                >
            ...
            {/* User Info Card */}
            <div
                className={`rounded-card p-6 mb-8 border ${isDark
            ...
            >
                ...
                {user?.department && (
                    <div
                        className={`pt-4 border-t ${isDark ? 'border-dark-border-subtle' : 'border-light-border-subtle'
                            }`}
                    >
                        <p
                            className={`text-caption sm:text-small mb-1 ${isDark ? 'text-text-dark-muted' : 'text-text-light-muted'
                                }`}
                        >
                            Department
                        </p>
...
const StatCard = ({ isDark, icon, title, value }) => (
    ...
    >
        ...
        <p
            className={`text-3xl sm:text-4xl font-comfortaa font-bold leading-tight ${isDark ? 'text-text-dark-primary' : 'text-text-light-primary'
                }`}
        >
            {value}
        </p>
